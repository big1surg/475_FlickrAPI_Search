...
namespace FlickrViewer {
    public partial class FlickrViewerForm : Form {
        // Use your Flickr API key here--you can get one at:http://www.flickr.com/services/apps/create/apply
        private const string KEY = "3872588b6ae6c8fb80b0ef393a52267b";
        ...
        public FlickrViewerForm() {InitializeComponent();} // end constructor
        ...
        private async void searchButton_Click(object sender, EventArgs e) {
            ...
            if (flickrTask != null && flickrTask.Status != TaskStatus.RanToCompletion) {
                ...
                var result = MessageBox.Show("Cancel the current Flickr search?", "Are you sure?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                if (result == DialogResult.No)
                    ...
                    client.CancelAsync();// cancel current search
            } // end if
            ...
            var flickrURL = string.Format("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&tag_mode=all&privacy_filter=1&per_page=500&", KEY, inputTextBox.Text.Replace(" ", " , "));
            ...
            try {
                ...
                flickrTask = client.DownloadStringTaskAsync(flickrURL);
                // await fickrTask then parse results with XDocument
                XDocument pa = XDocument.Parse(await flickrTask);
                ...
                var flickrPhotos =
                   from photo in pa.Descendants("photo")
        ...
        private async void imagesListBox_SelectedIndexChanged(object sender, EventArgs e) {
            if (imagesListBox.SelectedItem != null) {
                ...
                WebClient selImage = new WebClient();
                ...
                byte[] imageBytes = await selImage.DownloadDataTaskAsync(selectedURL);
